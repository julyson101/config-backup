...
## How to run it?
In order to run it, log-in to the development server (ubnt-jumpserver) and change to the project folder. From there, run the python code by issuing the command: python3 src/main.py

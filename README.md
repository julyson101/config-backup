...
#2. How to run it:
  In order to run it, log-in to the development server (ubnt-jumpserver) and go to the project folder. From the project folder, run the python code by issuing command: python3 src/main.py
